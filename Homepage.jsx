...
export default function Homepage() {
  ...
  return (
    <div className="min-h-screen bg-[#fefdf8]">
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@400;500;600;700&family=Playfair+Display:wght@400;500;600;700;800;900&family=Inter:wght@300;400;500;600;700&display=swap');
        ...
        .text-shadow-gold {
          text-shadow: 0 2px 20px rgba(212, 175, 105, 0.3);
        }
      `}</style>

      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#0a3d2f] via-[#1a5757] to-[#0a3d2f]">
        ...
        <div className="absolute top-20 left-10 animate-float" style={{animationDelay: '0s'}}>
          <Sparkles size={40} className="text-[#d4af69] opacity-20" />
        </div>
        <div className="absolute bottom-40 right-20 animate-float" style={{animationDelay: '2s'}}>
          <Clock size={60} className="text-[#d4af69] opacity-20" />
        </div>
        <div className="absolute top-1/3 right-1/4 animate-float" style={{animationDelay: '1s'}}>
          <Star size={30} className="text-[#d4af69] opacity-20" />
        </div>

        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center z-10">
          <div className="animate-fade-in-up">
            {/* Premium Badge */}
            <div className="inline-flex items-center gap-2 bg-[#d4af69]/10 border border-[#d4af69]/30 rounded-full px-6 py-2 mb-8">
              <Award size={20} className="text-[#d4af69]" />
              <span className="text-[#d4af69] font-semibold text-sm tracking-wider">ESTABLISHED 2020 • SWISS INSPIRED</span>
            </div>
            ...
            <h1 className="font-display text-6xl md:text-7xl lg:text-8xl font-bold text-white mb-6 leading-tight text-shadow-gold">
              Timeless Luxury,
              <br />
              <span className="text-[#d4af69]">Modern Precision</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
              <Link
                to="/collections/all"
                className="group gradient-gold text-white px-10 py-5 rounded-full font-bold text-lg shadow-2xl hover:shadow-[#d4af69]/50 transition-all flex items-center gap-3"
              >
            ...
            <div className="flex flex-wrap justify-center gap-8 text-white/80 text-sm">
              <div className="flex items-center gap-2">
                <Shield size={20} className="text-[#d4af69]" />
                <span>Authenticity Guaranteed</span>
              </div>
              <div className="flex items-center gap-2">
                <Truck size={20} className="text-[#d4af69]" />
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 animate-bounce">
          <div className="w-6 h-10 border-2 border-[#d4af69] rounded-full flex items-start justify-center p-2">
            <div className="w-1 h-3 bg-[#d4af69] rounded-full" />
          </div>
        </div>
      </section>

      {/* Press Mentions */}
      <section className="bg-white py-12 border-y border-[#9d8b7c]/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-center text-[#2a2a2a]/60 text-sm font-semibold uppercase tracking-wider mb-8">
            As Featured In
          </p>
          <div className="flex flex-wrap justify-center items-center gap-12 opacity-60 grayscale hover:grayscale-0 transition-all">
            {pressMentions.map((press, idx) => (
              <div key={idx} className="text-2xl font-bold text-[#2a2a2a]">
                {press.name}
              </div>
            ))}
          </div>
            ...
            {stats.map((stat, idx) => {
              ...
              return (
                <div key={idx} className="text-center">
                  <div className="inline-flex items-center justify-center w-16 h-16 bg-[#d4af69]/20 rounded-full mb-4">
                    <Icon size={28} className="text-[#d4af69]" />
                  </div>
      ...
      <section className="py-20 bg-[#fefdf8]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 mb-4">
              <div className="w-12 h-px bg-gradient-gold" />
              <Sparkles size={20} className="text-[#d4af69]" />
              <div className="w-12 h-px bg-gradient-gold" />
            </div>
            <h2 className="font-display text-5xl lg:text-6xl font-bold text-[#0a3d2f] mb-4">
              Curated Collections
            </h2>
                    ...
                    >
                      <div className="relative overflow-hidden rounded-3xl shadow-2xl aspect-[3/4]">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                          ...
                          <div className="flex items-center gap-2 text-[#d4af69] font-semibold">
                            <span>Explore Collection</span>
                    ...
                    {collections.map((_, idx) => (
                      <button
                        ...
                        className={`h-2 rounded-full transition-all ${
                          idx === carouselIndex ? 'w-8 bg-[#d4af69]' : 'w-2 bg-[#9d8b7c]/30'
                        }`}
                      />
                    ))}
                  </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 mb-4">
              <TrendingUp size={24} className="text-[#d4af69]" />
              <span className="text-[#d4af69] font-semibold uppercase tracking-wider">Best Sellers</span>
            </div>
            <h2 className="font-display text-5xl lg:text-6xl font-bold text-[#0a3d2f] mb-4">
              Customer Favorites
            </h2>
      ...
      <section className="py-20 bg-gradient-to-br from-[#fefdf8] to-[#f5f1e8]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-display text-5xl lg:text-6xl font-bold text-[#0a3d2f] mb-4">
              The Vastara Promise
            ...
            {trustBadges.map((badge, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="font-heading text-2xl font-bold text-[#0a3d2f] mb-3">
                    {badge.title}
                  </h3>
      ...
      <section className="py-20 bg-gradient-forest text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <Quote size={48} className="text-[#d4af69] mx-auto mb-6" />
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-12 border border-white/20">
              <div className="flex items-center gap-1 mb-6 justify-center">
                {[...Array(testimonials[activeTestimonial].rating)].map((_, i) => (
                  <Star key={i} size={24} className="fill-[#d4af69] text-[#d4af69]" />
                ))}
              </div>
              ...
              <div className="flex items-center justify-center gap-4">
                <div className="w-16 h-16 bg-[#d4af69] rounded-full flex items-center justify-center text-2xl font-bold">
                ...
                <div>
                  <div className="font-bold text-lg flex items-center gap-2">
                    ...
                    {testimonials[activeTestimonial].verified && (
                      <CheckCircle2 size={18} className="text-[#d4af69]" />
                    )}
                  </div>
            ...
            <div className="flex justify-center gap-2 mt-8">
              {testimonials.map((_, idx) => (
                <button
                  ...
                  className={`h-2 rounded-full transition-all ${
                    idx === activeTestimonial ? 'w-8 bg-[#d4af69]' : 'w-2 bg-white/30'
                  }`}
                />
              ))}
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-forest rounded-3xl p-12 text-center text-white relative overflow-hidden">
            <div className="absolute inset-0 opacity-10">
              <div className="absolute inset-0" style={{
                backgroundImage: 'radial-gradient(circle at 2px 2px, #d4af69 1px, transparent 0)',
            ...
            <div className="relative z-10">
              <Mail size={48} className="text-[#d4af69] mx-auto mb-6" />
              ...
              <form onSubmit={handleNewsletterSubmit} className="flex flex-col sm:flex-row gap-4 max-w-xl mx-auto">
                <input
                  ...
                  required
                  className="flex-1 px-6 py-4 rounded-full text-[#0a3d2f] outline-none focus:ring-4 focus:ring-[#d4af69]/50"
                />
                <button
                  type="submit"
...
function ProductCard({product, index}) {
  ...
  return (
    ...
    >
      <div className="relative aspect-square overflow-hidden bg-[#fefdf8]">
        ...
        >
          <Heart
            size={20}
            className={isWishlisted ? 'fill-red-500 text-red-500' : 'text-[#2a2a2a]'}
          />
        </button>
      ...
      <div className="p-6">
        <div className="flex items-center gap-1 mb-2">
          ...
          <span className="text-sm text-[#2a2a2a]/60 ml-1">(4.8)</span>
        </div>

        <h3 className="font-heading text-xl font-semibold text-[#0a3d2f] mb-3 group-hover:text-[#d4af69] transition-colors line-clamp-2">
          {product.title}
        </h3>

        <div className="flex items-center gap-3">
          <span className="font-heading text-2xl font-bold text-[#0a3d2f]">
            ${price.toFixed(2)}
          </span>
          {comparePrice > price && (
            <span className="text-lg text-[#2a2a2a]/40 line-through">
